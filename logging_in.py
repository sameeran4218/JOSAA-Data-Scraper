...
institute_name_entered=input('Enter the name of the institute')
...
select_institute_name.select_by_visible_text(institute_name_entered)
...
select_seat_type.select_by_visible_text('OPEN')
